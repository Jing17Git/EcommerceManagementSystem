...
<span class="trending-badge inline-flex items-center gap-2 bg-amber-400 text-gray-900 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider mb-4"><i class="fas fa-fire"></i> @if($index === 0)Trending Now @elseif($index === 1)Featured @else New Arrival @endif</span>
                    <h2 class="display-font text-5xl text-white mb-4 leading-tight font-bold">Discover Amazing Products</h2>
                    <p class="text-white/90 text-lg mb-2">Find quality products at great prices</p>
        ...
        <div class="carousel-slide absolute inset-0 opacity-100" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
            <div class="absolute inset-0 bg-gradient-to-r from-black/70 to-black/30 flex items-center px-16">
                <div class="max-w-xl">
                    ...
                    <h2 class="display-font text-5xl text-white mb-4 leading-tight font-bold">Shop the Best Products</h2>
                    <p class="text-white/90 text-lg mb-2">Find quality products at great prices</p>
    ...
    <div class="max-w-7xl mx-auto px-6 mb-10">
                ...
                <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 mb-8 text-white">
                    <h2 class="display-font text-3xl font-bold mb-3">Welcome to ShopHub!</h2>
                    <p class="text-white/90 text-lg mb-4">Discover quality products from trusted sellers. Every purchase comes with our satisfaction guarantee.</p>
...
<footer class="bg-[#1a1a2e] mt-auto">
    <div class="max-w-7xl mx-auto px-6 py-12">
        <div class="grid grid-cols-4 gap-8">
            ...
            <div class="col-span-1">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('sell') }}" class="text-sm text-gray-300 hover:text-orange-400 transition">Sell on ShopHub</a></li>
                </ul>
            </div>
            ...
            <div class="col-span-1">
                ...
                <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-sm text-gray-300">{{ \App\Models\PageContent::get('footer', 'contact', 'address', 'Philippines') }}</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="fas fa-phone text-orange-500"></i>
                        <span class="text-sm text-gray-300">{{ \App\Models\PageContent::get('footer', 'contact', 'phone', '+63 912 345 6789') }}</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <i class="fas fa-clock text-orange-500"></i>
                        <span class="text-sm text-gray-300">{{ \App\Models\PageContent::get('footer', 'contact', 'hours', 'Mon - Sat: 9AM - 7PM') }}</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p class="text-sm text-gray-400">&copy; {{ date('Y') }} {{ \App\Models\PageContent::get('footer', 'company', 'name', 'ShopHub') }}. All rights reserved.</p>
